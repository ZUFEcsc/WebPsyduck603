...
<body>
	...
	<div class="container">
		...
		<div class="row mt-3">
			<div class="col-sm-8">
				<h2>${info }</h2>
				<form action="${pageContext.request.contextPath}/admin/ActSignUpServlet" method="post">
					<!-- 输入用户名信息 -->
					...
					<!-- 活动开始时间 -->
					<div class="form-group row">
						<label for="aend" class="col-sm-3 col-form-label">活动开始时间</label>
						<div class="col-sm">
					...
					<div class="form-group row">
						...
						<div class="col-sm">
							<input type="date" name="astart" class="form-control"
								value="2020-01-01">
						</div>
						----
						<div class="col-sm">
							<input type="date" name="aend" class="form-control"
								value="2021-01-01">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm">
							<textarea class="form-control" name="atext" rows="3"></textarea>
						</div>
					</div>
					
					<div class="form-group row">
						<div class="col-sm-10">
							<button type="submit" class="btn btn-primary">活动发布</button>
						</div>
					</div>
				</form>
			</div>
