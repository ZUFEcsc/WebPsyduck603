		...
		<div class="logincard text-center">
			...
			<form class="form-signin" action="LoginServlet" method="post">
				...
				<label for="inputUsername" class="sr-only">Username</label> <input
					...
					placeholder="UserName" value="${inputusername}" required autofocus> <label
					for="inputPassword" class="sr-only">Password</label> <input
					type="password" name="Password" class="form-control"
					placeholder="Password" required> <label for="inputPassword"
					class="sr-only">Code</label> <input type="text" name="Usercode"
				...
				<label> <input type="checkbox" value="remember-me">
					Remember me <a href="Reg">Click to sign up</a>
				</label>
